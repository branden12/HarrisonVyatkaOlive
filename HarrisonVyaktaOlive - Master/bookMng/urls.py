...
urlpatterns = [
    ...
    path('addfavoritespost/',views.addfavoritespost,name="addfavoritespost"),
    ...
    path('favorites/feature_favorites/removefavorites/<int:book_id>', views.remove_favorites, name='removefavorites'),
    ]
